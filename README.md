...
**适合场景**：需要通过浏览器访问项目信息和 API 文档

项目提供了完整的网页模板，可以通过浏览器访问项目介绍、功能说明和 API 文档。
...
> **💡 提示**：也可以直接在浏览器中打开项目根目录的 `index.html` 文件查看简化版介绍页面。
> 
> 详细使用说明请参考 [Web 模板使用指南](WEB_TEMPLATES_GUIDE.md)。
...
├── index.html                # 项目主页（可直接打开）✨
├── WEB_TEMPLATES_GUIDE.md    # Web 模板使用指南 ✨
