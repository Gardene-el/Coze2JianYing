...
* **material\_url** (str, optional): 视频素材 URL
...
* **clip\_settings** (Optional\[ClipSettings], optional): 图像调节设置
* **crop\_settings** (Optional\[CropSettings], optional): 裁剪设置
