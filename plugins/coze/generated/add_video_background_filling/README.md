# add\_video\_background\_filling
...
* **fill\_type** (str, required): 填充类型: blur 或 color
* **blur** (Optional\[float], optional): 模糊程度（fill\_type=blur 时）
* **color** (Optional\[str], optional): 填充颜色（fill\_type=color 时）
