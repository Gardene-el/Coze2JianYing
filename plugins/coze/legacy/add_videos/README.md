...
## 与 add\_images 和 add\_audios 的比较

| 特性 | add\_videos | add\_images | add\_audios |
|------|-----------|------------|------------|
| 素材范围 | ✅ 支持 | ❌ 不支持 | ✅ 支持 |
| 速度控制 | ✅ 支持 | ❌ 不支持 | ✅ 支持 |
| 反向播放 | ✅ 支持 | ❌ 不支持 | ❌ 不支持 |
...
### Q: material\_start 和 start 的区别是什么？
...
### Q: speed 和 material\_range 如何配合使用？
