...
**重要说明 - start/end 与 material\_start/material\_end 的区别**：
...
2. **material\_start/material\_end（素材裁剪）**：
   * 定义从源素材中**截取哪一段**来播放
...
**素材时间（material\_start/material\_end）**:
...
### 与 make\_image\_info 和 make\_audio\_info 的比较

| 特性 | make\_video\_info | make\_image\_info | make\_audio\_info |
|------|----------------|-----------------|-----------------|
| 素材范围 | ✅ 支持 | ❌ 不支持 | ✅ 支持 |
| 速度控制 | ✅ 支持 | ❌ 不支持 | ✅ 支持 |
| 反向播放 | ✅ 支持 | ❌ 不支持 | ❌ 不支持 |
