...
1. **create\_draft** → 创建基础草稿结构
2. **add\_media\_tracks** → 添加视频/音频轨道
3. **add\_text\_tracks** → 添加文字/字幕轨道
4. **add\_effects** → 添加特效和滤镜
5. **export\_drafts** → 导出完整草稿数据
...
* **清理机制**: 及时使用export\_drafts导出并清理临时文件
