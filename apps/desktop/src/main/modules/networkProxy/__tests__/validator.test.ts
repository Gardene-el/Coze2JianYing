  ...
  describe('validate', () => {
    ...
    describe('authentication validation', () => {
      ...
      it('should reject when auth is enabled but username is missing', () => {
        ...
        expect(result.isValid).toBe(false)
        expect(result.errors).toContain('Proxy username is required when authentication is enabled')
      })
      ...
      it('should reject when auth is enabled but password is missing', () => {
        ...
        expect(result.isValid).toBe(false)
        expect(result.errors).toContain('Proxy password is required when authentication is enabled')
      })
