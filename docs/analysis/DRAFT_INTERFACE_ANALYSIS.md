...
✅ **视频基础**: material, time\_range, material\_range, speed\
✅ **视频变换**: position, scale, rotation, opacity\
✅ **视频裁剪**: crop settings\
✅ **视频效果**: filter, transition, background\
✅ **音频基础**: material, time\_range, material\_range, speed, volume\
✅ **音频效果**: fade\_in, fade\_out, effect\
✅ **文本完整**: content, style, border, shadow, background, alignment, animations\
✅ **图片完整**: 所有视频参数 + fit\_mode + intro/outro animations\
✅ **特效完整**: effect\_type, time\_range, intensity, position, custom properties\
...
⚠️ **flip\_horizontal / flip\_vertical** (视频段)
...
3. **背景模糊和颜色** - 需通过特殊技术实现
4. **音频效果** - effect\_type 和 intensity
5. **特效位置和缩放** - 局部特效控制
...
* [pyJianYingDraft 项目](https://github.com/GuanYixuan/pyJianYingDraft) - 剪映草稿生成库的 README
