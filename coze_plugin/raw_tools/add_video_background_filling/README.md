...
## API 信息
- **函数名**: add_video_background_filling
- **路径**: /video/{segment_id}/add_background_filling
- **方法**: POST
- **Request Model**: AddBackgroundFillingRequest
- **Response Model**: AddBackgroundFillingResponse
