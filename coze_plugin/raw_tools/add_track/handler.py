...
class Input(NamedTuple):
    """add_track 工具的输入参数"""
    draft_id: str  # 草稿ID
    track_type: str  # 轨道类型: audio/video/text/sticker/effect/filter
...
if {repr(args.input.track_name)} is not None:
...
"""
        ...
        return Output(success=True, track_index=0, message="操作成功", error_code=None, category=None, level=None, details=None)._asdict()
