...
# 时间: {time.strftime('%Y-%m-%d %H:%M:%S')}
    ...
    # 构造 request 对象
    req_{generated_uuid} = CreateStickerSegmentRequest(material_url=args.input.material_url, target_timerange=args.input.target_timerange, position=args.input.position, scale=args.input.scale)
