...
class Input(NamedTuple):
    ...
    segment_id: str
    transition_type: Optional[str] = Ellipsis
    duration: Optional[Any] = "1s"
...
segment_id_{generated_uuid} = "{generated_uuid}"
    ...
    # 构造 request 对象
    req_{generated_uuid} = AddTransitionRequest(transition_type=args.input.transition_type, duration=args.input.duration)

resp_{generated_uuid} = await add_video_transition(segment_id_{generated_uuid}, req_{generated_uuid})
"""
