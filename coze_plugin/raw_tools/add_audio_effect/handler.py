...
resp_raw_{generated_uuid} = await add_audio_effect(segment_{args.input.segment_id}, req_{generated_uuid})
resp_{generated_uuid} = AddAudioEffectResponse(**resp_raw_{generated_uuid})
"""
