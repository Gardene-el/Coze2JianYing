...
class Input(NamedTuple):
    ...
    segment_id: str
    time_offset: Optional[Any] = Ellipsis
    value: Optional[float] = Ellipsis
...
segment_id_{generated_uuid} = "{generated_uuid}"
        ...
        # 构造 request 对象
        req_{generated_uuid} = AddKeyframeRequest(time_offset=args.input.time_offset, value=args.input.value, property=args.input.property)

resp_{generated_uuid} = await add_sticker_keyframe(segment_id_{generated_uuid}, req_{generated_uuid})
"""
