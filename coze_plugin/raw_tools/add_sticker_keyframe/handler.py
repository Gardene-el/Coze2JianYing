...
resp_raw_{generated_uuid} = await add_sticker_keyframe(segment_{args.input.segment_id}, req_{generated_uuid})
resp_{generated_uuid} = AddStickerKeyframeResponse(**resp_raw_{generated_uuid})
"""
