...
自动从 API 端点生成: /sticker/{segment_id}/add_keyframe
...
"""
        ...
        return Output(success=True, keyframe_id="", message="操作成功", error_code=None, category=None, level=None, details=None, api_call=api_call)._asdict()
