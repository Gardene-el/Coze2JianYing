...
class Input(NamedTuple):
    ...
    segment_id: str  # 片段ID
    effect_id: str  # 花字特效 ID


# Output 类型定义
class Output(NamedTuple):
    """add_text_effect 工具的输出参数"""
...
resp_raw_{generated_uuid} = await add_text_effect(segment_{args.input.segment_id}, req_{generated_uuid})
resp_{generated_uuid} = AddTextEffectResponse(**resp_raw_{generated_uuid})
"""
