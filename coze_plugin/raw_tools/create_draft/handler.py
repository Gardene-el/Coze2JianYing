...
class Input(NamedTuple):
    ...
    fps: int = 30  # 帧率
    allow_replace: bool = True  # 是否允许替换同名草稿


# Output 类型定义
class Output(NamedTuple):
    """create_draft 工具的输出参数"""
    draft_id: str = ""  # 草稿 UUID
...
"""
        ...
        return Output(draft_id=f"{generated_uuid}", success=True, message="操作成功", error_code=None, category=None, level=None, details=None)._asdict()
