...
segment_id_{generated_uuid} = "{generated_uuid}"
    ...
    # 构造 request 对象
    req_{generated_uuid} = AddEffectRequest(effect_type=args.input.effect_type, params=args.input.params)

resp_{generated_uuid} = await add_video_effect(segment_id_{generated_uuid}, req_{generated_uuid})
"""
