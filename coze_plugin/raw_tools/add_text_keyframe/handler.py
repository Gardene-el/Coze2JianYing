...
resp_raw_{generated_uuid} = await add_text_keyframe(segment_{args.input.segment_id}, req_{generated_uuid})
resp_{generated_uuid} = AddTextKeyframeResponse(**resp_raw_{generated_uuid})
"""
