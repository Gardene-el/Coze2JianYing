...
class Input(NamedTuple):
    ...
    segment_id: str
    animation_type: Optional[str] = Ellipsis
...
segment_id_{generated_uuid} = "{generated_uuid}"
    ...
    # 构造 request 对象
    req_{generated_uuid} = AddAnimationRequest(animation_type=args.input.animation_type, duration=args.input.duration)

resp_{generated_uuid} = await add_video_animation(segment_id_{generated_uuid}, req_{generated_uuid})
"""
