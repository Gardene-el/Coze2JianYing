...
# 时间: {time.strftime('%Y-%m-%d %H:%M:%S')}
        ...
        # 构造 request 对象
        req_{generated_uuid} = CreateAudioSegmentRequest(material_url=args.input.material_url, target_timerange=args.input.target_timerange, source_timerange=args.input.source_timerange, speed=args.input.speed, volume=args.input.volume, change_pitch=args.input.change_pitch)
