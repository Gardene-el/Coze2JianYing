...
mask_{generated_uuid} = resp_{generated_uuid}.mask_id
"""
        ...
        return Output(success=True, mask_id="", message="操作成功", error_code=None, category=None, level=None, details=None)._asdict()
