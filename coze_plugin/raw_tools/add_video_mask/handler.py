...
class Input(NamedTuple):
    ...
    segment_id: str
    mask_type: Optional[str] = Ellipsis
    center_x: Optional[Any] = 0.0
    center_y: Optional[Any] = 0.0
    size: Optional[Any] = 0.5
    feather: Optional[Any] = 0.0
    invert: Optional[Any] = False
    rotation: Optional[Any] = 0.0
