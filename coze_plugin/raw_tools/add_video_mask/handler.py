...
resp_raw_{generated_uuid} = await add_video_mask(segment_{args.input.segment_id}, req_{generated_uuid})
resp_{generated_uuid} = AddVideoMaskResponse(**resp_raw_{generated_uuid})
"""
        ...
        return Output(success=True, mask_id="", message="操作成功", error_code=None, category=None, level=None, details=None)
